...
import { IndianRupee, Download, ArrowUpRight, Search } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row md:items-center justify-start gap-8">
        <div>
          <h1 className="text-4xl font-black text-white tracking-tight">Payment Transactions</h1>
          <p className="text-white/40 font-medium mt-1">Monitor revenue flow and transaction history.</p>
        </div>
    ...
    <Card className="relative group overflow-hidden">
      <div className="flex items-center justify-between mb-4">
        <div className="p-3 bg-white/5 rounded-xl group-hover:bg-accent/10 transition-colors">
          <IndianRupee className="w-6 h-6 text-white/40 group-hover:text-accent transition-colors" />
        </div>
